...
def GetFGDataFromTiff(Dictionary, JulDay):  #Gets the FG data from the tiff file (created in another script)
   ...
   #JulDay = 170 
   #im = io.imread('E:\\HenrikTSEB\\Fg_stations_only_output\\Fg_ImageEuropeMapCorrect.mosaic.tif')           #reading the tiff file created in the FG_stations script.
